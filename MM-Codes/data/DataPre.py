...
class dataPre():
    def __init__(self, args):
        ...
        if args.language == 'cn':
            ...
            self.tokenizer = tokenizer_class.from_pretrained(self.pretrainedBertPath)
        else:
            self.pretrainedBertPath = 'pretrained_model/bert_en'
            self.tokenizer = tokenizer_class.from_pretrained(self.pretrainedBertPath, do_lower_case=True)
...
def parse_args():
    ...
    parser.add_argument('--working_dir', type=str, default='/home/sharing/disk3/dataset/multimodal-sentiment-dataset/StandardDatasets/SIMS',
